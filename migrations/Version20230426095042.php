 ...
 */
final class Version20230426095042 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE inscription (id INT AUTO_INCREMENT NOT NULL, chambre_id INT DEFAULT NULL, participant_id INT DEFAULT NULL, user_id INT DEFAULT NULL, INDEX IDX_5E90F6D69B177F54 (chambre_id), INDEX IDX_5E90F6D69D1C3019 (participant_id), INDEX IDX_5E90F6D6A76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE licencie (id INT AUTO_INCREMENT NOT NULL, idclub_id INT DEFAULT NULL, qualite_id INT DEFAULT NULL, nom VARCHAR(255) NOT NULL, prenom VARCHAR(255) NOT NULL, adresse1 VARCHAR(255) NOT NULL, cp INT NOT NULL, ville VARCHAR(255) NOT NULL, tel INT NOT NULL, mail VARCHAR(255) NOT NULL, dateadhesion DATE NOT NULL, numlicence VARCHAR(255) NOT NULL, adresse2 VARCHAR(255) NOT NULL, INDEX IDX_3B755612BE1D585C (idclub_id), INDEX IDX_3B755612A6338570 (qualite_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
